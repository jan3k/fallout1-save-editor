...
def _fallout1_contract_details(contracts: dict[str, Any]) -> dict[str, Any]:
    required = ["character_summary", "progression", "detect", "compatibility", "inventory_editable", "map_summary", "save_diff"]
    return {
...
def run_release_audit() -> dict[str, Any]:
    ...
    f1_required_read_only = {"character-summary": "read_only", "progression": "read_only"}
