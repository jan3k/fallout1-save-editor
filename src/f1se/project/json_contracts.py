...
CONTRACTS: tuple[JsonPayloadContract, ...] = (
    ...
    C("combat_summary", "combat-summary SLOT --json", ("game_kind", "slot_path", "identity", "special", "hp", "action_points", "armor_class", "melee_damage", "carry_weight", "sequence", "healing_rate", "critical_chance", "resistances", "status_effects", "fields", "summary", "warnings", "read_only"), (), True, "Fallout 1 read-only combat summary."),
    C("special_set", "special-set SLOT STAT VALUE --json", ("game_kind", "stat", "field", "changed", "written", "write_required", "backup_path", "warnings", "read_only", "mode"), ("slot_path", "save_dat", "path", "old_value", "new_value", "diffs", "diff", "sha256_after"), False, "Fallout 1/Fallout 2 SPECIAL editor payload."),
    C("skill_set", "skill-set SLOT SKILL VALUE --json", ("game_kind", "skill", "field", "changed", "written", "write_required", "backup_path", "warnings", "read_only", "note"), ("slot_path", "save_dat", "path", "old_value", "new_value", "diffs", "diff", "sha256_after"), False, "Fallout 1/Fallout 2 skill editor payload."),
    ...
    C("fallout2_writable_fields", "fallout2-writable-fields SLOT --json", ("game_kind", "path", "slot_path", "fields", "warnings", "read_only", "allow_advanced"), (), True, "Fallout 2 writable semantic field catalog."),
    C("fallout2_set", "set SLOT FIELD VALUE --game fallout2 --json", ("game_kind", "path", "slot_path", "field", "diff", "changed", "written", "write_required", "backup_path", "warnings", "read_only"), ("sha256_after",), False, "Fallout 2 allowlisted semantic set payload."),
...
CONTRACT_FIELD_TYPES: dict[str, dict[str, str]] = {
    ...
    "combat_summary": {"game_kind": "str", "slot_path": "str", "identity": "dict", "special": "dict", "hp": "dict", "action_points": "int", "armor_class": "int", "melee_damage": "int", "carry_weight": "int", "sequence": "int", "healing_rate": "int", "critical_chance": "int", "resistances": "dict", "status_effects": "dict", "fields": "dict", "summary": "dict", "warnings": "list", "read_only": "bool"},
    "special_set": {"game_kind": "str", "stat": "str", "changed": "bool", "written": "bool", "write_required": "bool", "backup_path": "str_or_none", "warnings": "list", "read_only": "bool", "mode": "str", "slot_path": "str", "save_dat": "str", "path": "str", "old_value": "int", "new_value": "int", "diffs": "list", "diff": "dict", "sha256_after": "str"},
    "skill_set": {"game_kind": "str", "skill": "str", "changed": "bool", "written": "bool", "write_required": "bool", "backup_path": "str_or_none", "warnings": "list", "read_only": "bool", "note": "str", "slot_path": "str", "save_dat": "str", "path": "str", "old_value": "int", "new_value": "int", "diffs": "list", "diff": "dict", "sha256_after": "str"},
    ...
    "fallout2_writable_fields": {"game_kind": "str", "path": "str", "slot_path": "str", "fields": "dict", "warnings": "list", "read_only": "bool", "allow_advanced": "bool"},
    "fallout2_set": {"game_kind": "str", "path": "str", "slot_path": "str", "field": "dict", "diff": "dict", "changed": "bool", "written": "bool", "write_required": "bool", "backup_path": "str_or_none", "warnings": "list", "read_only": "bool", "sha256_after": "str"},
