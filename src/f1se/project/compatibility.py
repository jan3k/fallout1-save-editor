...
def compatibility_payload() -> dict[str, Any]:
    f1 = {
        ...
        "combat-summary": _capability("read_only", "Fallout 1 combat summary reports HP, AP, AC, combat stats, resistances and statuses without mutation."),
    ...
    f2 = {
        ...
        "combat-summary": _capability("not_supported", "Combat summary is currently implemented for Fallout 1 only."),
