...
- fixture matrix, fixture-check, fixture-status and guided fixture-import workflow;
- no-change byte-identical round-trip tests;
...
Use `fixture-plan` to see the recommended real-save corpus, `fixture-status` to inspect coverage, and `fixture-import` to copy a reviewed real save into `tests/fixtures` with a generated manifest entry.

See `docs/fixture_import.md` and `docs/fixtures.md`.
